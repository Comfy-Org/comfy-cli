...
from comfy_cli.deploy_api_errors import DeployAPIError, bad_request, mapped_error, transport_error
from comfy_cli.http import assert_safe_url, request_json
...
class DeployClient:
    ...
    def create_deployment(
        ...
        *,
        ...
        if not build_version_id.strip():
            raise bad_request("buildVersionId is required")
        ...
        return self._request(
            _Request(
                ...
                parts=("deployments",),
                method="POST",
                body={"buildVersionId": build_version_id, "computeConfig": compute_config},
                headers=headers,
            )
        )
