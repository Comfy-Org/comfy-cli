...
STATUS_URL = f"https://builder.test/v1/build-versions/{RELEASE_ID}"
...
_ROUTES: dict[tuple[str, str], tuple[int, JsonObject]] = {
    ...
    ("POST", f"/v1/builds/{BUILD_ID}/versions"): (201, {"buildVersionId": RELEASE_ID, "statusUrl": STATUS_URL}),
    ("GET", f"/v1/builds/{BUILD_ID}/versions"): (
        200,
        {
            "versions": [
                {
    ...
    ("GET", f"/v1/build-versions/{RELEASE_ID}"): (
        200,
        {"id": RELEASE_ID, "status": "complete", "buildId": BUILD_ID, "version": 1, "deployable": True},
    ),
    ("GET", f"/v1/build-versions/{RELEASE_ID}/logs"): (
        200,
        {"versionId": RELEASE_ID, "os": "linux", "gpu": "nvidia", "log": "built\n", "truncated": False},
    ),
    ("GET", f"/v1/build-versions/{RELEASE_ID}/manifest"): (200, {"models": []}),
