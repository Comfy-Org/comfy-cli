...
COMMAND_SCHEMAS: dict[str, str] = {
    ...
    "comfy distribution get": "distribution_get",
    "comfy distribution version create": "distribution_version_create",
    "comfy distribution version list": "distribution_version_list",
    "comfy distribution version get": "distribution_version_get",
    "comfy distribution version logs": "distribution_version_logs",
    "comfy distribution validate": "distribution_validate",
    "comfy distribution delete": "distribution_delete",
    "comfy distribution update": "distribution_update",
    "comfy distribution resolve": "distribution_resolve",
    "comfy distribution base-images": "distribution_base_images",
    "comfy distribution build-targets": "distribution_build_targets",
    "comfy distribution model-dirs": "distribution_model_dirs",
